...
import { Fuel, Bridge, Ship, Settings } from 'lucide-react';
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div key={type}>
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="0"
                  className="w-full pl-3 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:outline-none transition-all font-bold text-red-600"
                  required
                />
              </div>
            </div>
        ...
        <button 
          type="submit"
          className="w-full bg-slate-800 hover:bg-slate-900 text-white font-bold py-3 rounded-xl transition-all active:scale-[0.98]"
        >
          Giderleri Kaydet
        </button>
      </form>
